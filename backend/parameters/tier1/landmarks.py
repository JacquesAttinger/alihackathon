"""
Chicago landmark buildings from the Commission on Chicago Landmarks.
Dataset: https://data.cityofchicago.org/resource/tdab-kixi.json
Requires: no API key
"""
import requests
...
URL = (
    "https://data.cityofchicago.org/resource/tdab-kixi.json"
    "?$limit=5000&$select=latitude,longitude"
)


class Landmarks(BaseParameter):
    key = "landmarks"
    ...
    def load(self, G: nx.MultiDiGraph) -> None:
        ...
        try:
            ...
            print(f"    {len(points)} landmarks loaded")
